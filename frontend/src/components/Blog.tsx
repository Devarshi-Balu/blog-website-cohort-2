...
const Blog: React.FC<props> = ({ title, content, publishedDate, className }) => {
    return (
        <div className="flex flex-col items-start justify-start">
            ...
            <div className="mt-4 text-base font-sans">{content} Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione expedita voluptates incidunt ullam nam veniam? Reiciendis praesentium inventore, commodi nemo recusandae nostrum officiis saepe voluptate beatae est ad error ipsam.
